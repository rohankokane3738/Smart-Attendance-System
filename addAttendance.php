...
<center>
    <font color="red"><b><big><u><h2>Add Students Attendence Here</h2></u></big></u></font>
</center>
...
<table border="1" cellspacing="0">
    <form method="POST">
        ...
        <tr>
            <th colspan="9">
        </br/><br/> <input type="submit" name="addAttendanceBTN" /></th>
        <br/><br/>
        </tr>
    </form>
</table>
...
<?php 
    if(isset($_POST['addAttendanceBTN']))
    {
        ...
        echo"<script>alert('Student Attendence Sheet');window.location='sas.php'</script>";
